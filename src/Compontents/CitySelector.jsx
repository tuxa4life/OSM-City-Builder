...
const CitySelector = () => {
    ...
    return <div style={{ zIndex: 1, position: 'absolute', top: '10px', right: '10px', padding: '10px 20px', backgroundColor: 'rgba(255, 255, 255, 0.6)', backdropFilter: 'blur(5px)', borderRadius: '7px', boxShadow: '0px 0px 7px 0px rgba(0,0,0,0.4)' }}>
