...
const Loading = () => {
    const cardStyle = { transition: '.5s all', zIndex: 4, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px', padding: '18px 22px', borderRadius: '12px', boxShadow: '0 6px 20px rgba(20,20,20,0.08)', backgroundColor: 'rgba(255, 255, 255, .6)', backdropFilter: 'blur(5px)', border: '1px solid rgba(0,0,0,0.04)', transform: 'translate(-50%, -50%)', position: 'fixed', top: '50%', left: '50%' }
