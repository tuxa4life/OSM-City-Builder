...
const ContextMenu = ({ close }) => {
    return <div style={{position: 'absolute', top: '10px', left: '10px', padding: '10px 20px', backgroundColor: 'rgba(255, 255, 255, 0.8)', borderRadius: '7px', boxShadow: '0px 0px 15px 0px rgba(0,0,0,0.4)'}}>
