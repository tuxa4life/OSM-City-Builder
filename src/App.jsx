...
const App = () => {
    ...
    return <div>
        {
            !mesh && <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', textAlign: 'center', padding: '30px', borderRadius: '15px', boxShadow: '0 8px 20px rgba(0,0,0,0.3)', fontFamily: 'Arial, sans-serif' }}>
                <h2 style={{ fontSize: '36px', margin: '0 0 15px 0', fontWeight: 'bold' }}>Welcome to OSM Map Builder</h2>
                <p style={{ fontSize: '20px', margin: '0' }}>Please select a country and its city to generate a 3D model.</p>
            </div>
